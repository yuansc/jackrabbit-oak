...
/**
 * Instances of {@code JGitReader} are responsible for reading records from segments.
 * <p>
...
public interface JGitReader {
     ...
     */
    @Nonnull
    JGitNodeState readNode(@Nonnull RecordId id);
     ...
     */
    @Nonnull
    JGitNodeState readHeadState(@Nonnull Revisions revisions);
     ...
     */
    @Nonnull
    JGitBlob readBlob(@Nonnull RecordId id);
}
